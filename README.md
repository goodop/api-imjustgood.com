...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td><a href="https://github.com/goodop/api-imjustgood.com/blob/main/Example/line_secondary.py">Example</a></td>
        </tr>
        <tr>
            <td>LINE Timeline</td>
        ...
        <tr>
            <td>Google Search</td>
            <td><a href="https://github.com/goodop/api-imjustgood.com/blob/main/Example/google_search.py">Example</a></td>
        </tr>
        <tr>
            <td>Google Image</td>
        ...
        <tr>
            <td>GIF Search</td>
            <td><a href="https://github.com/goodop/api-imjustgood.com/blob/main/Example/gif.py">Example</a></td>
        </tr>
        <tr>
